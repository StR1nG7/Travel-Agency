...
import {getToursThunkCreator, IFilterData, IOption, setCurrentFilter, setCurrentPage} from "../actions/actionCreators";
	...
	return (
			<label>
				<Select
						...
						onBlur={handleBlur}
						value={value}
						placeholder={<><i className={`mdi ${icons[id as keyof IFilterData]} `}></i> <span>{id}</span></>}
				/>
			</label>
	)
} );
